...
This project is a detailed frontend recreation of the Amazon desktop website. The goal of this project was to practice complex web layouts, master CSS Flexbox, and understand how large-scale e-commerce platforms structure their user interfaces. 
...
* **Multi-Page Architecture:** Includes distinct, linked pages for the main storefront, user registration, and order history.
...
* **Iconography:** Integrated FontAwesome for scalable, high-quality UI icons (search, location, cart, etc.).
